...
/*
|--------------------------------------------------------------------------
| CONSULTAR CÉDULAS CUMPLIMENTADAS
|--------------------------------------------------------------------------
*/
...
$sql = "
    ...
    WHERE c.estado = 'CUMPLIMENTADA'

    ORDER BY
        c.fecha_cumplimentacion DESC,
        c.id DESC
";
...
if (!$resultado) {
    ...
    $error =
        'Error al consultar las cédulas cumplimentadas: '
...
<head>
    ...
    <title>Cédulas cumplimentadas</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .badge-cumplimentada { background: #dcfce7; color: #166534; }
...
<div class="layout">
    ...
    <main class="main">
        ...
        <section class="content">
            ...
            <div class="card">
                <h2 class="card-title">Cédulas cumplimentadas</h2>

                <?php if (count($cedulas) === 0): ?>
                    <div class="empty">
                        <div class="empty-icon">✅</div>
                        <div class="empty-title">No hay cédulas cumplimentadas</div>
                        <div>Actualmente no existen cédulas cumplimentadas en el sistema.</div>
                    </div>
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($cedulas as $cedula): ?>
                                    <tr>
                                        ...
                                        <td><?= fecha_argentina($cedula['fecha_cumplimentacion']) ?></td>
                                        <td>
                                            <?php

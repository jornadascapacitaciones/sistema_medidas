...
<head>
    ...
    <title>Encargados - Sistema Medidas</title>
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Personal encargado de diligenciamientos</h2>
                    <a href="nuevo.php" class="btn btn-primary">+ Nuevo encargado</a>
                </div>

                <?php if (count($encargados) === 0 && $error === ""): ?>
                    <div class="sin-registros">
                        <p>No hay encargados registrados.</p>
                        <a href="nuevo.php" class="btn btn-primary">Registrar primer encargado</a>
                    </div>
                <?php elseif (count($encargados) > 0): ?>
                    <div class="tabla-contenedor">
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($encargados as $indice => $encargado): ?>
                                    <tr>
                                        <td class="numero"><?= $indice + 1 ?></td>
                                        <td><?= htmlspecialchars($encargado["jerarquia"]) ?></td>
                                        <td><strong><?= htmlspecialchars($encargado["apellido_nombre"]) ?></strong></td>
                                        <td><?= htmlspecialchars($encargado["telefono"]) ?></td>
                                        <td>
                                            <?php if ((int)$encargado["activo"] === 1): ?>
                                        ...
                                        <td>
                                            <?= date("d/m/Y H:i", strtotime($encargado["fecha_creacion"])) ?>
                                        </td>
                                        <td>
                                            <div class="acciones">
                                                <a href="editar.php?id=<?= (int)$encargado["id"] ?>" class="btn btn-warning">Editar</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
